    ...
    IOptions<StorageOptions> storageOptions)
{
    ...
    private async Task<MyBookingListItem> MapToMyBookingListItemAsync(
        ...
        new(
            ...
            MyBookingLabelMapper.MapCancellationReasonLabel(cancelAudit, booking.CancellationRequest),
            MyBookingLabelMapper.MapCancellationDetail(cancelAudit, booking.CancellationRequest),

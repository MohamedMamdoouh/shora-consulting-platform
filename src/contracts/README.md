...
**Ops (spec 08):** `ops.ts` includes `AdminOpsAlertDto`, `AdminOpsAlertsResponse`, `AdminOpsRunbookDto`, and `AdminOpsRunbooksResponse` for `GET /admin/ops/alerts` and `GET /admin/ops/runbooks`.

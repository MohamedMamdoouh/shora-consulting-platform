...
@Component({
  ...
  template: `
    ...
    <svg class="counseling-scene__svg" viewBox="0 0 400 360" xmlns="http://www.w3.org/2000/svg">
      <ellipse cx="200" cy="310" rx="120" ry="16" fill="rgba(138,121,196,0.06)" />
      <path
      ...
      <ellipse cx="195" cy="215" rx="18" ry="14" fill="#E8847A" opacity="0.85" />
      ...
      <ellipse cx="102" cy="255" rx="22" ry="18" fill="#4CAF7A" opacity="0.85" />
      <ellipse cx="92" cy="248" rx="14" ry="12" fill="#5CB88A" opacity="0.9" />
      <ellipse cx="112" cy="250" rx="12" ry="10" fill="#3D9A6A" opacity="0.8" />
    </svg>

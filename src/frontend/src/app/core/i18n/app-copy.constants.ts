...
export const APP_COPY = {
  brand: {
    name: 'دكتور محمود البنا',
    homeAriaLabel: 'دكتور محمود البنا — الرئيسية',
    siteDescription:
      'موقع دكتور محمود البنا لحجز جلسات استشارية فردية في العلاقات — مباشرة معي، بخصوصية تامة.',
  },
  instructor: {
    photoAlt: 'دكتور محمود البنا',
  },
  nav: {
    home: 'الرئيسية',
    about: 'عني',
  ...
  session: {
    ...
    flatPriceSubtitle: 'جلسة واحدة بسعر ثابت، مباشرة مع دكتور محمود البنا',
    priceLabel: 'السعر',
    durationLabel: 'المدة',
  ...
  about: {
    ...
    whoHeading: 'من أنا',
    whoParagraph1:
      'أنا دكتور محمود البنا، خبير علاقات. أؤمن أن فهم العلاقة يبدأ بالاستماع، وليس بإعطاء النصائح. أمتلك خبرة كبيرة في العلاقات وتحليلها، مع دراسة في علم النفس التطبيقي والنفسي. في الجلسات، أساعدك على فهم ما يحدث بوضوح، والتعبير عما يصعب قوله، واكتشاف ما يمكن تغييره وما يحتاج إلى التعامل معه بشكل مختلف.',
  ...
  booking: {
    phoneIntro: 'أدخل رقم الموبايل الذي سنستخدمه للتواصل معك.',
  ...
  client: {
    receiptPending:
      'تم استلام إيصال الدفع، وهو الآن قيد المراجعة. ستصلك رسالة بالبريد الإلكتروني بعد التأكيد.',
    receiptUploaded:
  ...
  admin: {
    ...
    dialog: {
      deleteWindowTitle: 'حذف الموعد المتاح',
      deleteWindowMessage: 'سيتم حذف هذا الموعد وإعادة توليد المواعيد المتاحة.',
      deleteWindowAction: 'حذف',
      windowSavedTitle: 'تم حفظ الموعد',
      windowAddedMessage: 'ستظهر المواعيد الجديدة حسب هذا الموعد المتاح.',
      windowUpdatedMessage: 'تم حفظ تعديلات الموعد المتاح.',
      windowDeletedTitle: 'تم حذف الموعد',
      windowDeletedMessage: 'ستتم إعادة توليد المواعيد المتاحة بدون هذا الموعد.',
      removeBlockedDateTitle: 'إزالة موعد غير متاح',
      removeBlockedDateMessage:
        'سيتم إزالة الموعد غير المتاح وإعادة توليد المواعيد المتاحة خلال هذا النطاق.',
      removeBlockedDateAction: 'إزالة',
      blockedDateAddedTitle: 'تمت إضافة موعد غير متاح',
      blockedDateAddedMessage: 'لن تظهر المواعيد خلال هذا الموعد غير المتاح في صفحة الحجز.',
      blockedDateRemovedTitle: 'تمت إزالة الموعد غير المتاح',
      blockedDateRemovedMessage: 'سيتم استعادة المواعيد المتاحة بعد إزالة هذا الموعد غير المتاح.',

...
const ALERT_KIND_LABELS: Record<string, string> = {
  ...
  OutboxDeadLetter: 'رسالة بريد معطّلة',
  OutboxDeadLetterBurst: 'تعطّل جماعي للبريد',
};

const CONTEXT_KEY_LABELS: Record<string, string> = {
  bookingId: 'معرّف الحجز',
  paymentId: 'معرّف الدفع',
  cancellationRequestId: 'معرّف طلب الإلغاء',
  ...
  lastError: 'آخر خطأ',
  deadLetterCount: 'عدد الرسائل المعطّلة',
  windowHours: 'نافذة الساعات',
  jobName: 'اسم المهمة',
  intervalSeconds: 'فترة التكرار (ثوانٍ)',
  intervalMultiplier: 'مضاعف الفترة',
  stalenessMinutes: 'دقائق التوقف',
  lastFailureAtUtc: 'آخر فشل',
};
